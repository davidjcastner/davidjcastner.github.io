    ...
    return (
        <div className="acquisition">
            <header className="acquisition-section">
                <h2>
                    <span className="acquisition-prompt">&gt;</span> cat opportunity.txt
                </h2>
            ...
            <section className="acquisition-section">
                <h2>
                    <span className="acquisition-prompt">$</span> services
                </h2>
                <ul className="acquisition-list">
                    <li>
                        <span className="tag tag--blue">Full-Stack Development</span> End-to-end web
                        applications, APIs, and databases
                    </li>
                    <li>
                        <span className="tag tag--purple">UI / UX Engineering</span>{' '}
                        Component-driven interfaces with React and TypeScript
                    </li>
                    <li>
                        <span className="tag tag--green">Data & Backend</span> Python scripting,
                        SQL/MongoDB, data pipelines
                    </li>
                    <li>
                        <span className="tag tag--cyan">Creative & Art</span> Digital art,
            ...
            <section className="acquisition-section">
                <h2>
                    <span className="acquisition-prompt">$</span> contact
                </h2>
                <p>
            ...
            <section className="acquisition-section">
                <h2>
                    <span className="acquisition-prompt">$</span> resume
                </h2>
